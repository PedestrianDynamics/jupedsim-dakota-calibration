"""Joint-calibration parameters (all 7) on all five Hermes widths, 3 seeds."""
...
kw = dict(desired_speed=1.55, radius=0.10967, time_gap=0.80693, strength_neighbor=2.4877,
          range_neighbor=0.28037, strength_geometry=4.3639, range_geometry=0.065905)
